...
const GameDetails = () => {
  ...
  if (error || !game) return (
    <div className="text-center py-24 space-y-6">
        ...
        <p className="text-xl text-(--text-text-dim)">Impossible de récupérer les détails de ce jeu.</p>
        ...
        <div className="p-10 md:w-1/2 flex flex-col justify-between space-y-8">
          <div className="space-y-6">
            <div className="flex justify-between items-start">
              <h1 className="text-5xl font-black text-text-text-main leading-tight tracking-tighter">
                {game.name}
              </h1>
              {game.metacritic && (
            ...
            <div className="grid grid-cols-2 gap-6 pt-4 border-t border-gray-800/50">
              ...
              <div className="space-y-1">
                ...
                <div className="text-sm font-bold text-text-text-main line-clamp-1">
            ...
            <div className="prose prose-invert max-w-none">
                <p className="text-(--text-text-dim) leading-relaxed line-clamp-4 hover:line-clamp-none transition-all cursor-pointer" dangerouslySetInnerHTML={{ __html: game.description }}></p>
            </div>
          </div>
